...
RcppExport SEXP _FOCuS_FOCuS_offline_sim(SEXP YSEXP, SEXP thresSEXP, SEXP gridSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
    Rcpp::traits::input_parameter< double >::type thres(thresSEXP);
    Rcpp::traits::input_parameter< std::list<double>& >::type grid(gridSEXP);
    rcpp_result_gen = Rcpp::wrap(FOCuS_offline_sim(Y, thres, grid));
    return rcpp_result_gen;
END_RCPP
}
// test
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_FOCuS_FOCuS_offline_sim", (DL_FUNC) &_FOCuS_FOCuS_offline_sim, 3},
